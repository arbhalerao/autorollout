...
KIND_CLUSTER ?= autorollout-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name autorollout-builder
	$(CONTAINER_TOOL) buildx use autorollout-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm autorollout-builder
	rm Dockerfile.cross
